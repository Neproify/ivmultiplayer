...
public:
	...
	PAD(IVVehicle, pad1, 0x203);  // 0D61-0F64
	...
	PAD(IVVehicle, pad2, 0x3);    // 0F69-0F6C
	...
	PAD(IVVehicle, pad18, 0x18);  // 1324-133C
	DWORD m_dwHorn;               // 133C-1340
	PAD(IVVehicle, pad19, 0xD90); // 1340-20D0
