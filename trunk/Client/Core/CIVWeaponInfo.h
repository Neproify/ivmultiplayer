...
{
	WEAPON_RPOJECTILE_TYPE_NONE,
	WEAPON_RPOJECTILE_TYPE_FUSE,
	WEAPON_RPOJECTILE_TYPE_IMPACT,
	WEAPON_RPOJECTILE_TYPE_ROCKET,
	WEAPON_RPOJECTILE_TYPE_STICKY,
	WEAPON_RPOJECTILE_TYPE_UNKNOWN,
	WEAPON_RPOJECTILE_TYPE_MAX
};
