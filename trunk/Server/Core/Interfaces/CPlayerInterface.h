...
public:
	...
	virtual void           SetCoordinates(const CVector3& vecPosition) = 0;
	virtual void           GetCoordinates(CVector3& vecPosition) = 0;
	virtual void           SetHeading(float fHeading) = 0;
	virtual float          GetHeading() = 0;
	virtual void           SetVelocity(const CVector3& vecMoveSpeed) = 0;
	virtual void           GetVelocity(CVector3& vecMoveSpeed) = 0;
